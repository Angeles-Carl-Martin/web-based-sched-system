        ...
        <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
          ...
          <ResponsiveContainer width="100%" height={300}>
            <BarChart data={weeklyAttendance}>
              ...
              />
              <Legend />
              <Bar key="present-bar" dataKey="present" fill="#10B981" name="Present" />
              <Bar key="absent-bar" dataKey="absent" fill="#EF4444" name="Absent" />
              <Bar key="late-bar" dataKey="late" fill="#F59E0B" name="Late" />
            </BarChart>
          </ResponsiveContainer>
        </div>
